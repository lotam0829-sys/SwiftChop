...
const faqs = [
  ...
  { q: 'How is the delivery fee calculated?', a: 'Delivery fees are based on the distance between the restaurant and your delivery address. A base fee of \u20A61,000 plus \u20A6150 per mile applies. For long-distance orders, we recommend choosing a nearby restaurant for a lower delivery fee.' },
