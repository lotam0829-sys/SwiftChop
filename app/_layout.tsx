  ...
  return (
    <>
      ...
      <Stack screenOptions={{ headerShown: false, animation: 'fade' }}>
        ...
        <Stack.Screen name="restaurant-order/[id]" options={{ animation: 'slide_from_right', headerShown: false }} />
        ...
        <Stack.Screen name="restaurant-help" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-terms" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-hours" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-delivery" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-photos" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-bank" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        <Stack.Screen name="restaurant-notifications" options={{ animation: 'slide_from_right', headerShown: true, headerTitle: '', headerBackTitle: '', headerBackTitleVisible: false, headerTintColor: '#FFF', headerStyle: { backgroundColor: '#0D0D0D' } }} />
        ...
        <Stack.Screen name="deals" options={{ animation: 'slide_from_right', headerShown: false }} />
        <Stack.Screen name="review" options={{ presentation: 'modal', animation: 'slide_from_bottom', headerShown: false }} />
        <Stack.Screen name="edit-rider-profile" options={{ animation: 'slide_from_right', headerShown: false }} />
      </Stack>
    </>
  );
}
