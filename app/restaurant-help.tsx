...
const faqSections = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How is the delivery fee calculated?', a: 'Delivery fees are automatically calculated based on the distance between your restaurant and the customer. The formula is \u20A61,000 base fee plus \u20A6150 per mile. You do not need to set this manually.' },
    ],
  },
];
